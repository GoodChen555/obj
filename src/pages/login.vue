		 ...
		 <uc-nav bg-color="transparent" :border-width="0" arrow="gray"></uc-nav>
		  ...
		  <ul>
		    <li class="lifirst">
		     ...
		     <uc-input type="text" v-model="username" label="账户"/>
		    </li>
		    <li>
		    
		    <uc-input type="password" v-model="password" label="密码"/>
		    </li>
		  </ul>
		  <div class="footbox">
		 <uc-button text="登录" bg-color="gray" @click="login"/>
		 {{mess}}
...
<script>
	...
	import UcButton from "../components/uc-button/uc-botton.vue"
export default {
  name: 'login',
  props: {
